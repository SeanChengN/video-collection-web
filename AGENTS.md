...
- `src/styles/**/*.css` is the editable CSS source; files are concatenated by `scripts/build-css.js`.
- App design tokens, themes, Bulma bridge styles, reusable `vc-*` components, and utilities live in `src/styles/system/`.
